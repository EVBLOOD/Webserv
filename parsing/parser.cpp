...
template<>
void parser::separating<simpledir>(std::list<tokengen>::iterator &begin, std::list<tokengen>::iterator &end,
...
template<>
void parser::separating<context_location>(std::list<tokengen>::iterator &begin, std::list<tokengen>::iterator &end,
                                          bool server) {
...
template<>
void parser::separating<context_server>(std::list<tokengen>::iterator &begin, std::list<tokengen>::iterator &end,
                                        bool serv) {
